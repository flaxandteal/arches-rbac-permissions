...
from arches.app.permissions.arches_permission_base import get_nodegroups_by_perm_for_user_or_group
...
class DjangoGroupProcessor:
    ...
    def _process_single_group(self, django_group: DjangoGroup) -> None:
        ...
        group_key = self._operator._subj_to_str(django_group)
    ...
    def _process_nodegroup_permissions(self, django_group: DjangoGroup, group_key: str) -> None:
        ...
        nodegroups = {
            str(nodegroup.pk): set(perms) if perms else set(self._operator.graph_remappings.values())
    ...
    def _process_map_layer_permissions(self, django_group: DjangoGroup, group_key: str) -> None:
        ...
        for map_layer in MapLayer.objects.all():
            ...
            map_layer_key = self._operator._obj_to_str(map_layer)
            for perm in perms:
