...
APP_NAME = "arches_semantic_roles"
...
DATATYPE_LOCATIONS += ["arches_semantic_roles.datatypes"]
PERMISSION_LOCATIONS += ["arches_semantic_roles.permissions"]
RULE_LOCATIONS += ["arches_semantic_roles.rules"]
MIDDLEWARE += [
    "arches_semantic_roles.utils.middleware.CurrentUserMiddleware"
]
...
ARCHES_RBAC_PERMISSIONS_APPS = (
    *ARCHES_RBAC_PERMISSIONS_APPS,
    "arches_querysets",
    "arches_user_datatype",
    "arches_inclusion_rule",
    "arches_saved_search",
